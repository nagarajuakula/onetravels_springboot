...
const routes = [
    {
        path: 'products',
        loadChildren: () => Promise.all(/*! import() | products-products-module */[__webpack_require__.e("common"), __webpack_require__.e("products-products-module")]).then(__webpack_require__.bind(null, /*! ./products/products.module */ "./src/app/products/products.module.ts")).then(m => m.ProductsModule)
    },
    { path: 'cart',
        loadChildren: () => Promise.all(/*! import() | cart-cart-module */[__webpack_require__.e("common"), __webpack_require__.e("cart-cart-module")]).then(__webpack_require__.bind(null, /*! ./cart/cart.module */ "./src/app/cart/cart.module.ts")).then(m => m.CartModule)
    },
    {
        path: 'auth',
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 4, vars: 1, consts: [[3, "title"], [1, "container", 2, "padding-top", "15px"], [1, "row"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
...
/* harmony import */ var _shared_interceptors_auth_interceptor_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./shared/interceptors/auth-interceptor.service */ "./src/app/shared/interceptors/auth-interceptor.service.ts");
...
AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({ factory: function AppModule_Factory(t) { return new (t || AppModule)(); }, providers: [
        { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_6__["HTTP_INTERCEPTORS"], useClass: _shared_interceptors_auth_interceptor_service__WEBPACK_IMPORTED_MODULE_10__["AuthInterceptor"], multi: true }
    ], imports: [[
...
class AuthService {
    ...
    login(user) {
        this.user = user;
        return this.http.post(_shared_constants__WEBPACK_IMPORTED_MODULE_4__["USER_API"] + "/login", user, { reportProgress: true, responseType: 'text' })
    ...
    signup(user) {
        this.user = user;
        return this.http.post(_shared_constants__WEBPACK_IMPORTED_MODULE_4__["USER_API"] + "/create", user, { responseType: 'text' });
    }
    delete(id) {
...
class TokenStorageService {
    ...
    getToken() {
        const token = sessionStorage.getItem(_shared_constants__WEBPACK_IMPORTED_MODULE_1__["AUTH_KEY"]);
...
/* harmony import */ var _products_services_products_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../products/services/products.service */ "./src/app/products/services/products.service.ts");
...
function HeaderComponent_li_22_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HeaderComponent_li_22_Template_a_click_2_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r4); const ctx_r3 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r3.addProduct(); });
...
function HeaderComponent_li_31_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "div");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](2, "a", 21);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HeaderComponent_li_31_Template_a_click_2_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r6); const ctx_r5 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r5.login(); });
...
function HeaderComponent_li_32_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HeaderComponent_li_32_Template_span_click_9_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r9); const ctx_r8 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r8.logout(); });
...
class HeaderComponent {
    constructor(cartService, router, aRoute, authService, productService) {
...
HeaderComponent.ɵfac = function HeaderComponent_Factory(t) { return new (t || HeaderComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_cart_services_cart_service__WEBPACK_IMPORTED_MODULE_1__["CartService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_auth_services_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_products_services_products_service__WEBPACK_IMPORTED_MODULE_4__["ProductsService"])); };
HeaderComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: HeaderComponent, selectors: [["app-header"]], decls: 34, vars: 5, consts: [[1, "navbar", "navbar-expand-lg", "bg-primary"], [1, "container"], ["type", "button", "data-toggle", "collapse", "data-target", "#navbarTogglerDemo03", "aria-controls", "navbarTogglerDemo03", "aria-expanded", "false", "aria-label", "Toggle navigation", 1, "navbar-toggler"], [1, "navbar-toggler-bar", "navbar-kebab"], [1, "logo"], ["routerLink", "", 1, "simple-text", "logo-mini"], [1, "logo-image-small"], ["src", "assets/images/IMG_0069.JPG"], ["routerLink", "", 1, "navbar-brand", 2, "color", "azure", "padding-left", "0.3125rem"], ["id", "navbarTogglerDemo03", 1, "collapse", "navbar-collapse", "justify-content-end"], [1, "navbar-nav", "mt-2", "mt-lg-0"], [1, "nav-item"], [1, "input-group", "no-border"], ["type", "text", "id", "search", "name", "search", "autocomplete", "off", "placeholder", "Search...", 1, "form-control", 3, "ngModel", "ngModelChange"], [1, "input-group-append"], [1, "input-group-text"], [1, "nc-icon", "nc-zoom-split"], ["class", "nav-item", 4, "ngIf"], ["routerLink", "/cart", "routerLinkActive", "active", 2, "color", "black"], [1, "fa", "fa-shopping-cart"], [1, "mt-2"], [2, "cursor", "pointer", "color", "black", 3, "click"], ["mat-icon-button", "", "aria-label", "Example icon-button with a menu", 3, "matMenuTriggerFor"], ["menu", "matMenu"], ["mat-menu-item", ""], [3, "click"]], template: function HeaderComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function HeaderComponent_Template_input_ngModelChange_17_listener($event) { return ctx.productService.searchTerm = $event; });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](HeaderComponent, [{
    ...
    }], function () { return [{ type: _cart_services_cart_service__WEBPACK_IMPORTED_MODULE_1__["CartService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }, { type: _auth_services_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"] }, { type: _products_services_products_service__WEBPACK_IMPORTED_MODULE_4__["ProductsService"] }]; }, null); })();
...
class ProductsService {
    ...
    getProducts() {
        ...
        return this.http.get(src_app_shared_constants__WEBPACK_IMPORTED_MODULE_3__["PRODUCTS_API"], { reportProgress: true })
    ...
    updateProduct(product) {
        this.isLoading = true;
        this.http.put(src_app_shared_constants__WEBPACK_IMPORTED_MODULE_3__["PRODUCTS_API"], product, { reportProgress: true })
            .subscribe(data => {
    ...
    addProduct(product) {
        this.isLoading = true;
        this.http.post(src_app_shared_constants__WEBPACK_IMPORTED_MODULE_3__["PRODUCTS_API"], product, { reportProgress: true })
            .subscribe(data => {
            this.isLoading = false;
    ...
    deleteProduct(productId) {
        let reqUrl = src_app_shared_constants__WEBPACK_IMPORTED_MODULE_3__["PRODUCTS_API"] + "/" + productId;
...
ProductsService.ɵfac = function ProductsService_Factory(t) { return new (t || ProductsService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClient"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](src_app_services_snackbar_service__WEBPACK_IMPORTED_MODULE_5__["SnackBarService"])); };
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ProductsService, [{
    ...
    }], function () { return [{ type: _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClient"] }, { type: src_app_services_snackbar_service__WEBPACK_IMPORTED_MODULE_5__["SnackBarService"] }]; }, null); })();
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _shared_components_snackbar_snackbar_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../shared/components/snackbar/snackbar.component */ "./src/app/shared/components/snackbar/snackbar.component.ts");
...
SnackBarService.ɵfac = function SnackBarService_Factory(t) { return new (t || SnackBarService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_2__["MatSnackBar"])); };
...
SnackbarComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: SnackbarComponent, selectors: [["app-snackbar"]], decls: 4, vars: 4, consts: [[1, "flex"], [1, "data"], ["aria-hidden", "true"]], template: function SnackbarComponent_Template(rf, ctx) { if (rf & 1) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PRODUCTS_API", function() { return PRODUCTS_API; });
...
const PRODUCTS_API = "http://localhost:8080/onetravels/products";
const USER_API = "http://localhost:8080/onetravels/auth";
...
/* harmony import */ var _auth_services_token_storage_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../auth/services/token-storage.service */ "./src/app/auth/services/token-storage.service.ts");
...
class AuthInterceptor {
    constructor(tokenExtractor, tokenService) {
...
AuthInterceptor.ɵfac = function AuthInterceptor_Factory(t) { return new (t || AuthInterceptor)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpXsrfTokenExtractor"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_auth_services_token_storage_service__WEBPACK_IMPORTED_MODULE_3__["TokenStorageService"])); };
AuthInterceptor.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({ token: AuthInterceptor, factory: AuthInterceptor.ɵfac });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AuthInterceptor, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"]
    }], function () { return [{ type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpXsrfTokenExtractor"] }, { type: _auth_services_token_storage_service__WEBPACK_IMPORTED_MODULE_3__["TokenStorageService"] }]; }, null); })();
...
module.exports = __webpack_require__(/*! D:\Java Practise\onetravels-parent\onetravels-frontend\src\main.ts */"./src/main.ts");
